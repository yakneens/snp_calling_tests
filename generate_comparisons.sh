...
SAMPLE=${DATA_PREF}/mnist_na12878_chrom20_1mb_test.rheos.kafka.no_dels.vcf
GATK_VCF=${DATA_PREF}/mnist_na12878_chrom20.1mb.gatk4.filtered.vcf
FB_VCF=${DATA_PREF}/mnist_na12878_chrom20.1mb.freebayes.minimap.filtered.vcf
GIAB_VCF=${DATA_PREF}/na12878_giab_highconf.9999999-11000000.filtered.vcf
